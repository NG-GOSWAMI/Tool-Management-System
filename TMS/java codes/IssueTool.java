...
public class IssueTool extends JFrame implements ActionListener{

    private JPanel contentPane;
    JDateChooser dateChooser;
    private JTextField t1,t2,t3,t4,t6,t8,t9,t10,t11,t12,t13,t14;
	...
	JLabel l3 = new JLabel("ISI");
	l3.setForeground(new Color(47, 79, 79));
	l3.setFont(new Font("Tahoma", Font.BOLD, 14));
	l3.setBounds(47, 131, 100, 23);
	contentPane.add(l3);

	JLabel l4 = new JLabel("Seller");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issue-Tool",
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    t3.setText(rs.getString("isi"));
                    t4.setText(rs.getString("seller"));;
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    t10.setText(rs.getString("phone_no"));
            ...
            if(ae.getSource() == b3){
                    try{
                        ...
                        if(t9.getText().isEmpty()){
                            JOptionPane.showMessageDialog(null, "Fill the details to Issuez!");
                        }else{
                String sql = "insert into issueTool(tool_id, student_id, tname, sname, course, branch, dateOfIssue) values(?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, t1.getText());
		...
		if (i > 0)
                    JOptionPane.showMessageDialog(null, "Successfully Tool Issued..!");
		else
