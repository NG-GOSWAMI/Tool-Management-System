...
comboBox.setModel(new DefaultComboBoxModel(new String[] { "Mechanical", "Computer Science", "Civil", "EEE"}));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(new String[] { "B.E/B.Tech", "M.E/M.Tech"}));	
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into student(student_id, name, phone_no, course, branch, year, semester) values(?, ?, ?, ?, ?, ?, ?)";
