...
public class Status extends JFrame{
    ...
    public void issueTool() {
	try {
            conn con =  new conn();
            String sql = "select * from issueTool";
    ...
    public void returnTool() {
        try {
            conn con = new conn();
            String sql = "select * from returnTool";
            PreparedStatement st = con.c.prepareStatement(sql);
            ResultSet rs = st.executeQuery();
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issue-Tool-Details",
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tool\\management\\system\\icons\\tenth.png"));
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Return-Tool-Details",
